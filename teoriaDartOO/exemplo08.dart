...
//Classe Compromsso representa cada compromisso da agenda
class Compromisso {
  String titulo;
  String data;
  String hora;
  ...
  //Construtor com parâmetros nomeados e obrigatorios (required)
  Compromisso({
...
// Função para ler o texto com validação de null e vazio
...
void main() {
  ...
  do {
    ...
    // faz com que o programa continue repetindo o meni enquanto a variável opcao for diferente de 3.
  } while (opcao != 3);
}
